...
17 Pro, 2026-09-21); **never run on Android**. Three themes are selectable
from the menu (default Oxblood). Not yet built: notifications, safe-to-sleep, verified preset values, drink names in the log.
...
- **Publish gate:** doc-sync before anything goes public (push, PR, release).
  ...
  **Known gaps at first publish** (recorded rather than fixed, by choice): no
  `LICENSE` file (added 2026-09-21, MIT); preset caffeine values are recalled
  figures, not checked against a cited source; the name has US-only
...
The `LICENSE` file (MIT, 2026, DarelNC) was added on 2026-09-21. See
[stack.md](stack.md).
